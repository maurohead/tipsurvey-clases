...
use Curso\SurveyBundle\Entity\Survey;
use Curso\SurveyBundle\Form\SurveyType;
...
class SurveyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CursoSurveyBundle:Survey')->findAll();

        return $this->render('CursoSurveyBundle:Survey:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CursoSurveyBundle:Survey:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CursoSurveyBundle:Survey')->find($id);
        ...
        return $this->render('CursoSurveyBundle:Survey:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CursoSurveyBundle:Survey:edit.html.twig', array(
            'entity'      => $entity,
